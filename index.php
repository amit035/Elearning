...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to FreeLearn</h1>
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i>Free Online Courses</h5>
          </div>
          <div class="col-sm">
    ...
    <div class="container mt-5"> <!-- Start Most Popular Course -->
      <h1 class="text-center">Avaliable Course</h1>
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          ...
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.linkedin.com/in/amit-kumar-behera-748036199/"><i class="fab fa-linkedin"></i>linkedin</a>
          </div>
          <div class="col-sm">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>FreeLearn provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>FreeLearn <br> GIET University <br> Gunpur, odisha <br> Ph. 9178858919 </p>
          </div>
        </div>
      </div>
